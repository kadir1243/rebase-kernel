...
static inline int cpufreq_update_policy(unsigned int cpu) { return 0; }
static inline bool have_governor_per_policy(void) { return 0; }
static inline struct kobject *get_governor_parent_kobj(struct cpufreq_policy *policy) { return 0; }
#endif
